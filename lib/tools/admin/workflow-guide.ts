...
There is no separate release-agent prompt file today. Delivery phases reuse existing roles:
- promotion uses the reviewer prompt
- acceptance uses the tester prompt
